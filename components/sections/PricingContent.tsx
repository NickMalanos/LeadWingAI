    ...
    <>
        ...
        <Container className="space-y-8">
          <div className="animate-on-scroll max-w-3xl space-y-4">
            ...
            <p className="text-lg text-slate">
              Built for local service businesses that want to capture more
              leads, qualify enquiries, and book more jobs — automatically, 24/7.
            </p>
          </div>

          <div className="grid gap-6 lg:grid-cols-3">
            <article className="animate-on-scroll stagger-1 rounded-3xl border border-brandBlue/10 bg-white p-6 shadow-sm">
              <p className="text-sm font-semibold uppercase tracking-widest text-brandBlue">
                Standard
              </p>
              ...
              <p className="mt-3 text-sm text-slate">
                Best for single-location businesses that want to stop losing
                leads.
              </p>
              <ul className="mt-5 space-y-2 text-sm text-slate">
                <li>AI chatbot installed on 1 website</li>
                <li>Connects to Instagram</li>
                <li>Captures job type, location and urgency</li>
                <li>Guides customers to book or request a quote</li>
                <li>Connected to 1 booking system or enquiry form</li>
                <li>Lead notifications by SMS or email</li>
                <li>Text and email support</li>
              </ul>
              <p className="mt-5 rounded-2xl bg-brandBlue/5 p-4 text-sm font-medium text-ink">
                Perfect for businesses that want more booked jobs without
                hiring extra admin staff.
              </p>
            </article>

            <article className="animate-on-scroll stagger-2 rounded-3xl border border-brandGreen/10 bg-white p-6 shadow-sm">
              <p className="text-sm font-semibold uppercase tracking-widest text-brandBlue">
              ...
              <p className="text-sm text-slate">
                Per location. Volume tiers apply.
              </p>
              <p className="mt-3 text-sm text-slate">
              ...
              <ul className="mt-5 space-y-2 text-sm text-slate">
                <li>Chatbot for each location</li>
            ...
            <article className="animate-on-scroll stagger-3 rounded-3xl border border-brandOrange/10 bg-white p-6 shadow-sm">
              <p className="text-sm font-semibold uppercase tracking-widest text-brandBlue">
                Enterprise - Central Website
              </p>
              <p className="mt-2 text-3xl font-extrabold text-ink">
                From $199 / month
              </p>
      ...
      <AnimatedSection className="bg-mist/50">
        <Container className="space-y-4">
          <h2 className="animate-on-scroll text-2xl font-extrabold text-ink md:text-3xl">
            Why this works
          </h2>
          <ul className="grid gap-3 text-sm text-slate sm:grid-cols-2">
            <li className="animate-on-scroll stagger-1 rounded-2xl border border-brandBlue/10 bg-white p-4">
              Replies to every enquiry instantly, 24/7
            </li>
            <li className="animate-on-scroll stagger-2 rounded-2xl border border-brandBlue/10 bg-white p-4">
              Captures job details before you even pick up
            </li>
            <li className="animate-on-scroll stagger-3 rounded-2xl border border-brandBlue/10 bg-white p-4">
              Qualifies urgent versus standard work
            </li>
            <li className="animate-on-scroll stagger-4 rounded-2xl border border-brandBlue/10 bg-white p-4">
              Reduces admin time
            </li>
            <li className="animate-on-scroll stagger-1 rounded-2xl border border-brandBlue/10 bg-white p-4 sm:col-span-2">
              Turns website traffic into booked jobs and scales as your
              business grows
            </li>
          </ul>
        </Container>
